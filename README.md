...
<p>
Install Active Directory on DC-1. Once installed, go to the 'Active Directory Users and Computers' and create two organizational units titles ' _EMPLOYEES' and '_ADMINS'. Create a new admin account by adding a new user under the '_ADMINS' folder.
</p>
<br />
